...
namespace R_RPG
{
    class Tile_Data_Base
    {
        //配列宣言
        public readonly static int[] TextureData = new int[1024];
        public readonly static bool[] Tile_Collision = new bool[1024];
        //変数宣言
        public int TileId;public int GrHandle;

        //コンストラクタ
        public Tile_Data_Base(int TileId,int GrHandle ,bool TileCollision)
        {
            this.TileId = TileId;
    ...
    class Tile_Data
    {
        static public void TileData()
        {
            ...
            {//0 Transparent 透明 あたり判定なし
                ...
                new Tile_Data_Base(tileid, grhandle, tilecollision);
            }
            {//1 Transparent 透明
                tileid = 1;
                tilecollision = true;
