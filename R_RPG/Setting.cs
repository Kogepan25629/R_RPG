...
namespace R_RPG
{
    class Setting
    {
        ...
        // ゲームデータの保存場所のパス
        public static readonly byte Setting_GameDataPathMode = 1;   // 1="%appdata%"   2="./"

        // オプションファイル(option.txt)からオプションを読み込むかどうか
        public static readonly bool Setting_EnableLoadOptionsFile = true;
    }
}
